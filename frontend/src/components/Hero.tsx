  ...
  return (
    <section className="relative overflow-hidden px-4 pb-24 pt-16 sm:px-8 lg:px-12">
      ...
      <div className="mx-auto flex max-w-6xl flex-col-reverse gap-16 lg:flex-row lg:items-center">
        ...
        >
          <div className="inline-flex items-center gap-2 rounded-full border border-white/20 px-3 py-1 text-xs uppercase tracking-[0.2em] text-slate-200">
            Autonomous Subsidy Agent
            <span className="inline-flex h-2 w-2 rounded-full bg-cyan-300" />
          </div>
          <h1 className="font-display text-4xl leading-tight sm:text-5xl lg:text-6xl text-white">
            You are a farmer.<br />
            The drought hits.<br />
          ...
          <div className="flex flex-col gap-3 text-sm text-slate-200 sm:flex-row sm:flex-wrap">
